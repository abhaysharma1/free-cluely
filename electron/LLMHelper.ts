...
export class LLMHelper {
  ...
  private readonly systemPrompt = `You are an AI assistant that provides direct, concise answers to problems. Analyze what you see and provide only the solution or answer. Do not provide suggestions, explanations, or reasoning unless specifically asked.`;
  ...
  public async extractProblemFromImages(imagePaths: string[]) {
    try {
      ...
      const prompt = `${this.systemPrompt}\n\nAnalyze these images and extract the problem. Provide ONLY the answer to the problem in JSON format:\n{
  "problem_statement": "The problem shown in the images.",
  ...
  public async generateSolution(problemInfo: any) {
    const prompt = `${
      this.systemPrompt
    }\n\nGiven this problem provide ONLY the direct answer:\n${JSON.stringify(
      problemInfo,
      null,
      2
    )}\n\nProvide your response in the following JSON format:\n{
  "solution": {
    "answer": "The direct answer or solution here."
  }
}\nImportant: Return ONLY the JSON object, without any markdown formatting or code blocks.`;
  ...
  public async debugSolutionWithImages(
    ...
    try {
      ...
      // Android Bundling failed 1039ms node_modules\expo-router\entry.js (1 module)
      //  ERROR  node_modules\expo-router\entry.js: [BABEL] D:\Final Year Project\HealixChain\node_modules\expo-router\entry.js: .plugins is not a valid Plugin property}\

      const prompt = `${
        this.systemPrompt
      }\n\nGiven:\n1. The original problem: ${JSON.stringify(
        problemInfo,
        null,
        2
      )}\n2. The current solution: ${currentCode}\n3. Additional context from images\n\nProvide the correct answer in JSON format:\n{
  "solution": {
    "answer": "The direct answer or solution here."
  }
}\nImportant: Return ONLY the JSON object, without any markdown formatting or code blocks.`;
  ...
  public async analyzeAudioFile(audioPath: string) {
    try {
      ...
      const prompt = `${this.systemPrompt}\n\nAnalyze this audio and provide ONLY the direct answer to any problem or question present. Be brief and concise. Do not provide suggestions or explanations.`;
  ...
  public async analyzeImageFile(imagePath: string) {
    try {
      ...
      const prompt = `${this.systemPrompt}\n\nAnalyze this image and provide ONLY the direct answer to any problem or question shown. Be brief and concise. Do not provide suggestions, context, or explanations.`;
